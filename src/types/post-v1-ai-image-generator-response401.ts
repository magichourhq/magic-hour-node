...
import {
  External$PostV1AiImageGeneratorResponse401MessageEnum,
  PostV1AiImageGeneratorResponse401MessageEnum,
} from "./post-v1-ai-image-generator-response401-message-enum";
...
export type PostV1AiImageGeneratorResponse401 = {
  message: PostV1AiImageGeneratorResponse401MessageEnum;
};
...
export type External$PostV1AiImageGeneratorResponse401 = {
  message: External$PostV1AiImageGeneratorResponse401MessageEnum;
};
