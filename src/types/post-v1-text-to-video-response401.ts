...
import {
  External$PostV1TextToVideoResponse401MessageEnum,
  PostV1TextToVideoResponse401MessageEnum,
} from "./post-v1-text-to-video-response401-message-enum";
...
export type PostV1TextToVideoResponse401 = {
  message: PostV1TextToVideoResponse401MessageEnum;
};
...
export type External$PostV1TextToVideoResponse401 = {
  message: External$PostV1TextToVideoResponse401MessageEnum;
};
