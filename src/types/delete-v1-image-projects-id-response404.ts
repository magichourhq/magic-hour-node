...
import {
  ...
  External$DeleteV1ImageProjectsIdResponse404MessageEnum,
} from "./delete-v1-image-projects-id-response404-message-enum";
...
export type DeleteV1ImageProjectsIdResponse404 = {
  message: DeleteV1ImageProjectsIdResponse404MessageEnum;
};
...
export type External$DeleteV1ImageProjectsIdResponse404 = {
  message: External$DeleteV1ImageProjectsIdResponse404MessageEnum;
};
