...
import {
  ...
  External$DeleteV1ImageProjectsIdResponse401MessageEnum,
} from "./delete-v1-image-projects-id-response401-message-enum";
...
export type DeleteV1ImageProjectsIdResponse401 = {
  message: DeleteV1ImageProjectsIdResponse401MessageEnum;
};
...
export type External$DeleteV1ImageProjectsIdResponse401 = {
  message: External$DeleteV1ImageProjectsIdResponse401MessageEnum;
};
