...
import {
  External$PostV1AiPhotoEditorResponse401MessageEnum,
  PostV1AiPhotoEditorResponse401MessageEnum,
} from "./post-v1-ai-photo-editor-response401-message-enum";
...
export type PostV1AiPhotoEditorResponse401 = {
  message: PostV1AiPhotoEditorResponse401MessageEnum;
};
...
export type External$PostV1AiPhotoEditorResponse401 = {
  message: External$PostV1AiPhotoEditorResponse401MessageEnum;
};
