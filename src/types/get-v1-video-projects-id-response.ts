...
export type GetV1VideoProjectsIdResponse = {
  created_at: string;
  /**
   * The download url and expiry date of the video project
   */
  ...
  end_seconds: number;
  /**
   * Frame rate of the video. If the status is not &#x27;Complete&#x27;, then the cost is an estimate and will be adjusted when the video completes.
   */
  fps: number;
  /**
  ...
  /**
   * The amount of frames used to generate the video. If the status is not &#x27;Complete&#x27;, then the cost is an estimate and will be adjusted when the video completes.
   */
