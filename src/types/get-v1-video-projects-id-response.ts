...
import {
  External$GetV1VideoProjectsIdResponseStatusEnum,
  GetV1VideoProjectsIdResponseStatusEnum,
} from "./get-v1-video-projects-id-response-status-enum";
import {
  External$GetV1VideoProjectsIdResponseTypeEnum,
  GetV1VideoProjectsIdResponseTypeEnum,
} from "./get-v1-video-projects-id-response-type-enum";
...
export type GetV1VideoProjectsIdResponse = {
   ...
   */
  status: GetV1VideoProjectsIdResponseStatusEnum;
  /**
   * The amount of frames used to generate the video. If the status is not 'complete', the cost is an estimate and will be adjusted when the video completes.
   */
  totalFrameCost: number;
  type: GetV1VideoProjectsIdResponseTypeEnum;
  /**
...
export type External$GetV1VideoProjectsIdResponse = {
  ...
  status: External$GetV1VideoProjectsIdResponseStatusEnum;
  total_frame_cost: number;
  type: External$GetV1VideoProjectsIdResponseTypeEnum;
  width: number;
};
