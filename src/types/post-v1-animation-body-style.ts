...
/**
 * @internal
 * PostV1AnimationBodyStyle without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$PostV1AnimationBodyStyle = {
  art_style:
    | "3D Render"
    | "90s Streets"
    | "Abstract Minimalist"
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object PostV1AnimationBodyStyle
 */
const SchemaIn$PostV1AnimationBodyStyle: z.ZodType<
  PostV1AnimationBodyStyle, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$PostV1AnimationBodyStyle
 */
const SchemaOut$PostV1AnimationBodyStyle: z.ZodType<
  External$PostV1AnimationBodyStyle, // output type of this zod object
  z.ZodTypeDef,
  PostV1AnimationBodyStyle // the object to be transformed
> = z
  .object({
    artStyle: z.enum([
      "3D Render",
...
export const Schemas$PostV1AnimationBodyStyle = {
  in: SchemaIn$PostV1AnimationBodyStyle,
  out: SchemaOut$PostV1AnimationBodyStyle,
};
