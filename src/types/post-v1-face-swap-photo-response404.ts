...
import {
  External$PostV1FaceSwapPhotoResponse404MessageEnum,
  PostV1FaceSwapPhotoResponse404MessageEnum,
} from "./post-v1-face-swap-photo-response404-message-enum";
...
export type PostV1FaceSwapPhotoResponse404 = {
  message: PostV1FaceSwapPhotoResponse404MessageEnum;
};
...
export type External$PostV1FaceSwapPhotoResponse404 = {
  message: External$PostV1FaceSwapPhotoResponse404MessageEnum;
};
