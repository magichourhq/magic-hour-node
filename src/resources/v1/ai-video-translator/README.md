...
| ------------------ | :------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------- |
| `assets`           |    ✓     | Source video for the translation job.                                                                                                                                                                                                                                                                                                                                          | `{"videoFilePath": "api-assets/id/1234.mp4"}` |
...
| `targetLanguage`   |    ✓     | Language to translate the video's speech into.                                                                                                                                                                                                                                                                                                                                 | `"Spanish"`                                   |
...
const res = await client.v1.aiVideoTranslator.create({
...
[V1AiVideoTranslatorCreateResponse](/src/types/v1-ai-video-translator-create-response.ts)
