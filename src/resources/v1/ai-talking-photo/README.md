...
| `└─ intensity`      |    ✗     | Note: this value is only applicable when generation*mode is `expressive`. The value can include up to 2 decimal places. * Lower values yield more stability but can suppress mouth movement. \_ Higher values increase motion and expressiveness, with a higher risk of distortion.                                                                                                                            | `123.0`                                                                                  |
