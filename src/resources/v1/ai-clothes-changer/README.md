...
| `└─ garmentType`     |    ✗     | Type of garment to swap. If not provided, swaps the entire outfit. _ `upper_body` - for shirts/jackets _ `lower_body` - for pants/skirts _ `dresses` - for entire outfit (deprecated, use `entire_outfit` instead) _ `entire_outfit` - for entire outfit                                                                                                 | `"entire_outfit"`                                                                                                              |
